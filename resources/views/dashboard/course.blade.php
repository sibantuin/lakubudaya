            ...
            <div class="row mb-3">
                ...
                <div class="col-12 col-md-4">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari kursus... (nama, location, dan lainnya)">
                        <span class="input-group-text btn btn-primary" id="cari-kursus">
            ...
            <div class="row align-items-top">
                ...
                @foreach ($listData as $data)
                    <div class="col-12 col-md-4">
                        <div class="card">
                            <div class="p-2">
                                <img src="{{ asset('assets/img/dashboard/'.$data['photo']) }}" class="card-img-top" alt="..." style="max-height: 170px !important">
                            </div>
                            <div class="card-body px-2 pb-2">
                                ...
                                <div class="text-center">
                                    <a href="{{ route('cart') }}" class="btn btn-primary">
                                        <i class="bi bi-person-up" style="color: #fff !important;"></i>
                                        <span class="pl-2">Kursus</span>
                                    </a>
                                </div>
                            </div>
                        </div>
